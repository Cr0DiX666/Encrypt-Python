...
def main():
    ...
    if choice == '1' or choice == '01':
        try:
            ...
            d.write(b)
            d.close()
            print RR + '[*] ' + W + 'Berhasil Dibuat Dengan Nama:', c
            main()
        except:
    ...
    if choice == '5' or choice == '05':
        try:
            ...
            g.write(e)
            g.close()
            print RR + '[*] ' + W + 'Berhasil Dibuat Dengan Nama:', f
            main()
        except:
            print RR + '[-] ' + W + 'File not found!'
            main()
    ...
    if choice == '9' or choice == '09':
        sys.exit(RR + '[*] ' + W + 'See You Next Time ^_^')
    else:
            sys.exit(RR + '[*] ' + W + 'Semoga Bermanfaat ^_^')
